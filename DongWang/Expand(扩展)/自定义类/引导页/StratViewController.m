...
@interface StratViewController ()

/** <#des#> */
@property (nonatomic,strong) StratPageView * guideView;
...
@implementation StratViewController
...
{
    if(!_guideView){
        _guideView = [[StratPageView alloc] initWithFrame:[UIScreen mainScreen].bounds];
        kWeakSelf(self);
