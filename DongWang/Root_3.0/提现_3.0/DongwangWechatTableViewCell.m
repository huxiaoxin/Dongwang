...
@interface DongwangWechatTableViewCell ()
...
@end
@implementation DongwangWechatTableViewCell
...
-(void)TXBtnClick{
    [self.delegate DongwangWechatTableViewCellBtnTXAction];
}
-(void)setInfo:(UserInfo *)info{
    _info = info;
    
    _rightToplb.text = info.payName;
    _rightBtomlb.text =  info.wxName;
