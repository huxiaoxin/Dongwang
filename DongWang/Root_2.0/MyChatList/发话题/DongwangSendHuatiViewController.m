...
@interface DongwangSendHuatiViewController ()<DongwangSendChatCenterViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,RITLPhotosViewControllerDelegate,DongwangChatBtomViewDelegate>
...
@implementation DongwangSendHuatiViewController
...
-(DongwangSendChatCenterView *)CenterView{
    if (!_CenterView) {
        _CenterView = [[DongwangSendChatCenterView alloc]initWithFrame:CGRectMake(0, NaviH, SCREEN_WIDTH, 0)];
