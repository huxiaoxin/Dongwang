...
@interface DongwangDuihuanSuccedView ()
@property (nonatomic ,strong) UIView *deliverView; //底部View
@end
@implementation DongwangDuihuanSuccedView
-(instancetype)initWithFrame:(CGRect)frame withinfoMsg:(NSString *)infoStr{
    if (self = [super initWithFrame:frame]) {
        ...
        [sureBtn setTitle:@"去查看" forState:UIControlStateNormal];
...
-(void)DongwangAlterBtbClick:(UIButton *)btnType{
    
    [self removeFromSuperview];

    [self.delegate DongwangDuihuanSuccedViewDidSeltecdWithBtnIndex:btnType.tag];
}
/*
