...
@interface DongwangJifenMallView ()
@property (nonatomic ,strong) UIView *deliverView; //底部View

@end
@implementation DongwangJifenMallView
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        bakcImgView.image = [UIImage imageNamed:@"积分商城"];
...
-(void)DongwangMyTapActions{
    ...
    [self.delegate DongwangJifenMallViewRemove];
}
-(void)show{
